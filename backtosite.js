...
function addBtnHome() {
  ...
  if (referrer.indexOf("https://76ezgames.github.io/") !== -1) {
    ...
    e.id = 'inGame';
    e.innerHTML = `
      <img src="https://harveyhousework-github-io.vercel.app/imgs/backtosite.png" width="169px" height="78px" alt="Go back to main site">`;
    document.getElementsByTagName('body')[0].appendChild(e);
  }
}
...
function returnHome(){
    ...
    var newWindow = window.open("https://harveyhousework.github.io", "_blank");
    newWindow.document.title = "Back to Main Site";
}
function opendiscord(){
    window.open("https://harveyhousework.github.io");
}
